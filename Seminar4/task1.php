      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php for($i = 0; $i < count($experience); $i++): ?>
          <div class="w3-container">
            ...
            <?php if ($i == 0): ?>
              <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $experience[$i]['dateStart'] ?> - <span class="w3-tag w3-teal w3-round"><?= $experience[$i]['dateFinal'] ?></span></h6>
            <?php else: ?>
              <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $experience[$i]['dateStart'] ?> - <?= $experience[$i]['dateFinal'] ?></span></h6>
            <?php endif ?>
